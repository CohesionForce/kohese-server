 ...
 * @generated
 */
public class KoheseModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KoheseModelPackage.ITEM: {
				Item item = (Item)theEObject;
				T result = caseItem(item);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseModelPackage.DECISION: {
			...
			case KoheseModelPackage.WORKFLOW: {
			...
			case KoheseModelPackage.OBSERVATION: {
			...
			case KoheseModelPackage.ACTION: {
			...
			case KoheseModelPackage.MEASURE: {
			...
			case KoheseModelPackage.ASSIGNMENT: {
			...
			case KoheseModelPackage.MEDIA: {
				Media media = (Media)theEObject;
				T result = caseMedia(media);
				if (result == null) result = caseItem(media);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseModelPackage.IMAGE: {
			...
			case KoheseModelPackage.DOCUMENT: {
