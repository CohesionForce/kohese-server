 ...
 * @generated
 */
public class KoheseTypesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static KoheseTypesPackage modelPackage;
	 ...
	 * @generated
	 */
	public KoheseTypesSwitch() {
		if (modelPackage == null) {
			modelPackage = KoheseTypesPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case KoheseTypesPackage.ITEM: {
				Item item = (Item)theEObject;
				T result = caseItem(item);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.DECISION: {
				Decision decision = (Decision)theEObject;
				T result = caseDecision(decision);
				if (result == null) result = caseItem(decision);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.WORKFLOW: {
				Workflow workflow = (Workflow)theEObject;
				T result = caseWorkflow(workflow);
				if (result == null) result = caseItem(workflow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.OBSERVATION: {
				Observation observation = (Observation)theEObject;
				T result = caseObservation(observation);
				if (result == null) result = caseItem(observation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.JOURNAL: {
				Journal journal = (Journal)theEObject;
				T result = caseJournal(journal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.REPORT: {
				Report report = (Report)theEObject;
				T result = caseReport(report);
				if (result == null) result = caseItem(report);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = caseDecision(action);
				if (result == null) result = caseItem(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.ISSUE: {
				Issue issue = (Issue)theEObject;
				T result = caseIssue(issue);
				if (result == null) result = caseObservation(issue);
				if (result == null) result = caseItem(issue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.MEASURE: {
				Measure measure = (Measure)theEObject;
				T result = caseMeasure(measure);
				if (result == null) result = caseObservation(measure);
				if (result == null) result = caseItem(measure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case KoheseTypesPackage.ASSIGNMENT: {
				Assignment assignment = (Assignment)theEObject;
				T result = caseAssignment(assignment);
				if (result == null) result = caseItem(assignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
