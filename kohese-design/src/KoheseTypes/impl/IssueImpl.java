 ...
 * </p>
 * <ul>
 *   <li>{@link KoheseTypes.impl.IssueImpl#getResolution <em>Resolution</em>}</li>
 *   <li>{@link KoheseTypes.impl.IssueImpl#getAnalysis <em>Analysis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IssueImpl extends ObservationImpl implements Issue {
	...
	protected EClass eStaticClass() {
		return KoheseTypesPackage.Literals.ISSUE;
	}
		...
		if (resolution != null && resolution.eIsProxy()) {
			...
			if (resolution != oldResolution) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KoheseTypesPackage.ISSUE__RESOLUTION, oldResolution, resolution));
			}
		}
		return resolution;
	}
	...
	public void setResolution(Action newResolution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KoheseTypesPackage.ISSUE__RESOLUTION, oldResolution, resolution));
	}
	...
	public Action getAnalysis() {
		if (analysis != null && analysis.eIsProxy()) {
			...
			if (analysis != oldAnalysis) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KoheseTypesPackage.ISSUE__ANALYSIS, oldAnalysis, analysis));
			}
		}
		return analysis;
	}
	...
	public void setAnalysis(Action newAnalysis) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KoheseTypesPackage.ISSUE__ANALYSIS, oldAnalysis, analysis));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KoheseTypesPackage.ISSUE__RESOLUTION:
				if (resolve) return getResolution();
				return basicGetResolution();
			case KoheseTypesPackage.ISSUE__ANALYSIS:
