 ...
 * </p>
 * <ul>
 *   <li>{@link KoheseTypes.impl.WorkflowImpl#getAssignment <em>Assignment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowImpl extends ItemImpl implements Workflow {
	...
	protected EClass eStaticClass() {
		return KoheseTypesPackage.Literals.WORKFLOW;
	}
	...
	public EList<Assignment> getAssignment() {
		if (assignment == null) {
			assignment = new EObjectContainmentEList<Assignment>(Assignment.class, this, KoheseTypesPackage.WORKFLOW__ASSIGNMENT);
		}
		return assignment;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KoheseTypesPackage.WORKFLOW__ASSIGNMENT:
