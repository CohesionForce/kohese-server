 ...
 * </p>
 * <ul>
 *   <li>{@link KoheseTypes.impl.JournalImpl#getObservation <em>Observation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JournalImpl extends MinimalEObjectImpl.Container implements Journal {
	...
	protected EClass eStaticClass() {
		return KoheseTypesPackage.Literals.JOURNAL;
	}
	...
	public EList<Observation> getObservation() {
		if (observation == null) {
			observation = new EObjectResolvingEList<Observation>(Observation.class, this, KoheseTypesPackage.JOURNAL__OBSERVATION);
		}
		return observation;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KoheseTypesPackage.JOURNAL__OBSERVATION:
