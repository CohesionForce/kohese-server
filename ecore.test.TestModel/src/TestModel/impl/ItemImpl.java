...
public class ItemImpl extends MinimalEObjectImpl.Container implements Item {
	...
	protected EClass eStaticClass() {
		return TestModelPackage.Literals.ITEM;
	}
	...
	public EList<Item> getChild() {
		if (child == null) {
			child = new EObjectContainmentEList<Item>(Item.class, this, TestModelPackage.ITEM__CHILD);
		}
		return child;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestModelPackage.ITEM__NAME, oldName, name));
	}
